...
namespace Engine
{
	...
	typedef std::int16_t InputConstant;
	typedef std::int16_t InputAxis;

	// STOLEN FROM glfw3.h :)
	
	enum class KeyCode : InputConstant
	{
		/* Printable keys */
		INPUT_KEY_SPACE = 32,
	...
	enum class MouseButton : InputConstant 
	{
		/* Mouse Buttons */
	...
	enum class MouseAxis : InputAxis 
	{
		INPUT_AXIS_MOUSE_POS_X,
		INPUT_AXIS_MOUSE_POS_Y,
		INPUT_AXIS_MOUSE_SCROLL_X,
		INPUT_AXIS_MOUSE_SCROLL_Y
	};
